...
description: Custom form field control
heroImage: /Custom Field.png
---
...
Note that if your component implements ControlValueAccessor, it may already be set up to provide NG\_VALUE\_ACCESSOR (in the providers part of the component's decorator, or possibly in a module declaration). If so, you may get a cannot instantiate cyclic dependency error.

To resolve this, remove the NG\_VALUE\_ACCESSOR provider and instead set the value accessor directly:
