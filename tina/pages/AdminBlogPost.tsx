...
export default function AdminBlogPost(props: Props) {
	...
	return (
		<article>
			<div data-tina-field={tinaField(blog, "heroImage")} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} className="hero-image">
				{blog.heroImage && <img width={500} height={510} src={blog.heroImage} alt="" />}
			</div>
			<div className="prose">
				<div className="title">
